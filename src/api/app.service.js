...
const appService = {
    ...
    async updateBeer(id, data) {
        try {
            let response = await axios.put(`/beers/${id}`, data, {
                headers: {
    ...
    async getBeer(id, includeBrewers) {      
        try {
            let data = await axios.get(`/beers/${id}?include_brewers=${includeBrewers}`)
    ...
    async getBrewers(limit, order, offset) {
        try {
            let response = await axios.get(`/brewers?limit=${limit}&order=${order}&offset=${offset}`)
